...
module.exports = {
    ...
    ownernumber: process.env.Owner_Number || "62857xxxxxx",
    ...
    mongoUrl: process.env.MongoDB || "mongodb+srv://curserhannibal:voldigoad@cluster0.t1uhl.mongodb.net/?retryWrites=true&w=majority",
    sessionId: process.env.SESSION_ID || "YmtyZHB_AN_YA_kaXo=",
